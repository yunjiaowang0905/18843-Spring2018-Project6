...
def sys_run(i_t):
    ...
    result = particle_filter_run(config.get_data_upd_interp()[i_t],config.get_pf_upd_flag_adp(),i_t,config.get_x_est_adp(),config.get_P_w_adp(),config.get_x_P_adp(),config.get_u_mat_adp())
